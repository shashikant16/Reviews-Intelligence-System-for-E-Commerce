...
input_dir = r"E:\Projects\TRC Learning\CRF Decathlon"
temp_dir = 'temp'
output_dir = r'E:\Projects\TRC Learning\CRF Decathlon'
...
trainer.train('crf_decathlon_v2.model')

tagger = pycrfsuite.Tagger()
tagger.open('crf_decathlon_v2.model')
